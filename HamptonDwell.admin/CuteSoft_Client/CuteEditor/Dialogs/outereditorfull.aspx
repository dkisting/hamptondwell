...
<script runat="server">
	void Page_Load(object sender, System.EventArgs e)
	{
		...
		{				
			...
			Image1.Attributes["onclick"]="top.returnValue=null; (top.closeeditordialog||top.close)();";
		...
		{ 
			...
			HttpContext.Current.Response.Write("<script language='javascript'>top.returnValue=true;(top.closeeditordialog||top.close)();</scr" + "ipt>");
	    } 
