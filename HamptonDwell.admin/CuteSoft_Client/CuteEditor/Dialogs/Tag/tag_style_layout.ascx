...
<fieldset><legend>[[Size]]</legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			...
			<td><input type="text" id="tb_top" style="width:60px" />
			...
			<td><input type="text" id="tb_height" style="width:60px" />
		...
		<tr>
			...
			<td><input type="text" id="tb_left" style="width:60px" />
			...
			<td><input type="text" id="tb_width" style="width:60px" />
...
<fieldset><legend>[[Clipping]]</legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			<td style="width:50">[[Top]]</td>
			<td><input type="text" id="tb_cliptop" style="width:60px" />
			...
			<td><input type="text" id="tb_clipbottom" style="width:60px" />
		...
		<tr>
			<td style="width:50">[[Left]]</td>
			<td><input type="text" id="tb_clipleft" style="width:60px" />
			...
			<td><input type="text" id="tb_clipright" style="width:60px" />
...
<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1002&file=Dialog_Tag_Style_Layout.js"></script>
