...
var OxOc5a1=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOc5a1[1],true)[OxOc5a1[0]]=function (){if(event[OxOc5a1[2]]){alert(element[OxOc5a1[3]].cssText);} ;} ;
</script>
