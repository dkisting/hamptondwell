...
<html xmlns="http://www.w3.org/1999/xhtml">
											...
											<table border="0" cellpadding="1" cellspacing="0" class="normal">
												<tr>
													...
													<td>
														<input type="text" name="Width" id="Width" style="width: 80px;" onchange="do_preview()"
															onkeypress="return CancelEventIfNotDigit()" value="200" /></td>
												</tr>
												<tr>
													<td>
														[[Height]]:</td>
												...
												<tr>
													<td>
														[[AutoStart]]:</td>
													<td>
														<input type="checkbox" name="AutoStart" onchange="do_preview()" onpropertychange="do_preview()"
												...
												<tr>
													<td style="height: 24px">
														[[ShowControls]]:</td>
													<td style="height: 24px">
														<input type="checkbox" name="ShowControls" onchange="do_preview()" onpropertychange="do_preview()"
															id="ShowControls" checked="checked" value="ShowControls" /></td>
												</tr>
												<tr>
													<td>[[ShowStatusBar]]:</td>
													<td>
														<input type="checkbox" name="ShowStatusBar" onchange="do_preview()" onpropertychange="do_preview()"
															id="ShowStatusBar" value="ShowStatusBar" /></td>
												</tr>
												<tr>
													<td>[[WindowlessVideo]]:</td>
													<td>
														<input type="checkbox" name="WindowlessVideo" onchange="do_preview()" onpropertychange="do_preview()"
															id="WindowlessVideo" value="windowlessVideo" /></td>
												</tr>
											</table>
										</td>
									</tr>
	...
	<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1002&file=Dialog_InsertMedia.js"></script>
</html>
