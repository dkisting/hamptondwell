...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<tr>
						...
						<td>
							...
							<img id="btn_zoom_in" src="../Load.ashx?type=image&file=zoom_in.gif" onclick="Zoom_In();"
								...
								title="[[ZoomOut]]" class="dialogButton" /> <img id="btn_bestfit" src="../Load.ashx?type=image&file=bestfit.gif" onclick="BestFit();"
								title="[[BestFit]]" class="dialogButton" /> <img id="btn_Actualsize" src="../Load.ashx?type=image&file=Actualsize.gif" onclick="Actualsize();"
								title="[[ActualSize]]" class="dialogButton" /> <img id="img_AutoThumbnail" src="../Load.ashx?type=image&file=resize.gif" onclick="AutoThumbnail();"
								title="[[AutoThumbnail]]" class="dialogButton" />
							<% if(secset.AllowModify) {%>
							<img class="dialogButton" id="img_ImageEditor" src="../Load.ashx?type=image&file=imageeditor.gif"
								onclick="ImageEditor();" title="[[ImageEditor]]" />
							<%
						}
						else
						{
							...
							<fieldset>
								...
								<table border="0" cellpadding="2" cellspacing="0" width="100%">
									...
									<tr>
										<td>[[BorderColor]]:</td>
										<td style="text-align:left">
											<input type="text" id="bordercolor" name="bordercolor" size="7" /> <img title="" src="../Load.ashx?type=image&file=colorpicker.gif" id="bordercolor_Preview"
	...
	<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1002&file=Dialog_InsertImage.js"></script>
</html>
<script runat="server">
